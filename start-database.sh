...
DB_CONTAINER_NAME="pa4bf-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=pa4bf -d -p 5432:5432 docker.io/postgres
